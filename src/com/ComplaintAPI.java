...
public class ComplaintAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = compObj.insertComp(request.getParameter("customerName"),      
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = compObj.updateComp(paras.get("hidCompIDSave").toString(),     
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 ...
		 String output = compObj.deleteComp(paras.get("cID").toString());  
